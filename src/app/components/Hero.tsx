...
export function Hero({ onNavigate }: { onNavigate?: (target: string, category?: string) => void }) {
  ...
  return (
    <section className="px-6 md:px-8 pt-10 md:pt-16 pb-12 md:pb-20 grid grid-cols-1 lg:grid-cols-12 gap-10 md:gap-12 items-center relative overflow-hidden">
      ...
      <div className="lg:col-span-7 flex flex-col items-start z-10">
        ...
        <h1 className="text-4xl md:text-5xl lg:text-7xl font-black leading-[1.1] md:leading-[1] mb-6 md:mb-8 tracking-tighter"
            style={{ color: "var(--foreground)" }}>
          Digital Knowledge <br />
          <span style={{ color: "var(--primary)" }}>Open Library</span>
        </h1>
        
        <p className="text-sm md:text-base leading-relaxed mb-8 md:mb-12 opacity-80 max-w-lg font-bold" 
           style={{ color: "var(--foreground)" }}>
